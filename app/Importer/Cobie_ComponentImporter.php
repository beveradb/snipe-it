...
class Cobie_ComponentImporter extends ItemImporter
{
    ...
    {
        $this->log('Cobie importer - createAssetIfNotExists for row: ' . var_export($row, true));

        $editingAsset = false;
        $asset_tag = $this->findCsvMatch($row, "asset_tag");
        $this->log('asset_tag: ' . var_export($asset_tag, true));
        ...
        $this->log('Cobie importer about to call createOrFetchAssetModel: ' . var_export($row, true));
        $this->item['model_id'] = $this->createOrFetchAssetModel($row);
        $this->log('Cobie importer $this->item after model_id: ' . var_export($this->item, true));

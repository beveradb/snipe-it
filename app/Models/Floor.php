...
class Floor extends SnipeModel
{
    ...
    */
    ...
    /**
     * Sets the attribute of whether or not the floor is requestable
     *
     * This isn't really implemented yet, as you can't currently request a floor
    ...
    {
        return $this->hasMany('\App\Models\Actionlog', 'item_id')->where('item_type', Floor::class)->orderBy('created_at', 'desc')->withTrashed();
    }
    ...
    /**
     * Checks the number of available floors
     *
     * @author [A. Gianotto] [<snipe@snipe.net>]
     * @since [v4.0]
     * @return int

...
class CategoriesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $allowed_columns = ['id', 'name','category_type', 'category_type','use_default_eula','eula_text',
            'require_acceptance','checkin_email',
            'assets_count', 'accessories_count', 'consumables_count', 'components_count',
            'floors_count', 'licenses_count',
            'image'];
